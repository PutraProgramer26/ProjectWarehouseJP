...
// jika file di include oleh file lain, tampilkan isi file
  ...
  // jika module yang dipilih "penyesuaian_stok"
  elseif ($_GET['module'] == 'penyesuaian_stok' && $_SESSION['hak_akses'] != 'Kepala Gudang') {
    // panggil file tampil data penyesuaian stok
    include "modules/penyesuaian-stok/tampil_data.php";
  }
  // jika module yang dipilih "form_entri_penyesuaian_stok" dan hak akses bukan "Kepala Gudang"
  elseif ($_GET['module'] == 'form_entri_penyesuaian_stok' && $_SESSION['hak_akses'] != 'Kepala Gudang') {
    // panggil file form entri penyesuaian stok
    include "modules/penyesuaian-stok/form_entri.php";
  }
