        ...
        <div class="logo-header" data-background-color="purple">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand d-flex align-items-center">
              <img src="assets/img/logo.png" alt="Logo" style="height: 38px; width: auto; max-width: 140px; object-fit: contain;">
            </div>
          </a>
          <!-- Navbar Toggler -->
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              Copyright &copy; 2026 - <a href="#" class="text-secondary">Putra</a>.
            </div>
          </div>
        </footer>
        <!-- End Footer -->
